...
def prepare_dataloader(args):
    """Prepare the DataLoader for saving images and masks."""
    # Define data transformations
    transform = get_albu_transforms('test')
    ...
    dataset = HFDataset(
        ...
        common_transforms=transform,
        edge_width=args.edge_mask_width,
        post_funcs=None  # No post-processing needed
    )
